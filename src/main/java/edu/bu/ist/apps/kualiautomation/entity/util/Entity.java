...
public class Entity {
	...
	private Entity() { /* Restrict default constructor */ }
	
	public Entity(EntityManager em, boolean ignoreEmpties) {
		this.em = em;
	...
	public boolean populate(Object objectToPopulate, String getterMethodName, Object sourceEntity) throws Exception {
		Object targetEntity = ReflectionUtils.getAccessorValue(objectToPopulate, getterMethodName);
		EntityPopulator populator = new EntityPopulator(this, ignoreEmpties);
		...
		if(source.equals(target)) {
			...
			if(managedSource != null) {
				Method setterMethod = ReflectionUtils.getMutator(getterMethodName, objectToPopulate.getClass());
