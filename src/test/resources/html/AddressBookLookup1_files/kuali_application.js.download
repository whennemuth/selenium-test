...
function refreshAddressBookLookup() {
		...
		//  Enable editing Organization field in Address Book when adding New
		/*
		...
		*/
		if(document.getElementById('document.newMaintainableObject.sponsorAddressFlag')) {
			sponsorFlagValue = document.getElementById('document.newMaintainableObject.sponsorAddressFlag').value;
		...
		if(document.getElementById('sponsorAddressFlag')) {
			issponsorAddressValue = document.getElementById('sponsorAddressFlag').value;
